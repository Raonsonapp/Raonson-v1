...
// marketplaceSchema — ҷадвалҳои Creator Marketplace.
//
// Ҷудо аз migrate()-и асосӣ нигоҳ дошта мешавад, то схемаи мавҷуда
// бетағйир монад. Ҳама идемпотентанд (IF NOT EXISTS), мисли схемаи асосӣ.
//
// Пул ҲАМЕША бо воҳиди хурди БУТУН нигоҳ дошта мешавад (BIGINT дирам),
// на NUMERIC/float — то ҳисоб дақиқ бошад.
