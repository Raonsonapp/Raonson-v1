...
//
// Усул: HMAC-SHA256 аз сатри дархост бо сирри муштарак.
//
// ⚠️ YANDEX БА ИН РОҲ ЗАНГ НАМЕЗАНАД.
//
// Дар шарҳи пештара ин ҷо навишта шуда буд, ки «ҳамин усул дар
// Yandex S2S rewards истифода мешавад». Ин НОДУРУСТ буд ва санҷида
// нашуда буд. Yandex Mobile Ads server-side rewards умуман
// надорад: дар кабинети Yandex ҳеҷ майдони callback URL ва ҳеҷ
// майдони сир вуҷуд надорад, ва дар SDK (yandex_mobileads 7.18.0)
// ҳеҷ сатре нест, ки ба SSV ишора кунад — синфи Reward танҳо
// {type, amount} дорад.
//
// Пас барои Yandex мукофот аз роҳи дигар меояд: ads/session.go,
// ки ба хабари БЕБОВАРИ барнома такя мекунад ва онро маҳдуд
// мекунад.
//
// Ин файл НЕСТ карда намешавад. Ӯ хато надорад ва маҳз ҳамон чизест,
// ки барои шабакаи оянда бо SSV-и воқеӣ (масалан AdMob) лозим
// мешавад. То он вақт /ads/callback боз аст, вале ҳеҷ кас ба он
// занг намезанад.
