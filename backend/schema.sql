-- ════════════════════════════════════════════════════════════════════
--  Raonson — DB schema reference
--
--  SOURCE OF TRUTH: backend/db/db.go  migrate()
--  Migrations run AUTOMATICALLY on backend startup (idempotent,
--  CREATE TABLE/INDEX IF NOT EXISTS). You normally do NOT run this file
--  by hand. It is auto-mirrored from db.go so the two never drift.
--  Do NOT edit here — edit db.go migrate() instead, then re-sync.
-- ════════════════════════════════════════════════════════════════════
