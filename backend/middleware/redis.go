...
// қабул аст.
//
// ⚠️ ҲАДДИ ИН ҲАЛ: рақам дар ХОТИРАИ ҳамин раванд аст.
//
// Ҳозир Raonson дар ЯК нусха кор мекунад (HuggingFace Space), пас
// ин кофист. Агар рӯзе нусхаҳои зиёд шаванд, ҳазф дар нусхаи A
// кэши нусхаи B-ро намепартояд ва пости ҳазфшуда то охири TTL
// (30 сония) дар он ҷо мемонад.
//
// Он гоҳ рақамро бояд ба Redis бурд (INCR) ва дар ҳар дархост
// хонд — вале ин ба ҳар дархост як муроҷиати шабака илова мекунад,
