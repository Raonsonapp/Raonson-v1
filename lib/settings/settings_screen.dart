          ...
          body: ListView(
            ...
            children: [
              ...
              _NavTile(
                ...
                sub:   tr('invite.entrySub'),
                onTap: () => _go(ctx, const ReferralScreen()),
              ),
              // ── Ҷамъбасти ҳафта ──
              _NavTile(
                icon:  AppIcons.calendar_today_rounded,
                title: tr('recap.entry'),
                sub:   tr('recap.entrySub'),
                onTap: () => _go(ctx, const WeeklyRecapScreen()),
              ),
              // ── Студияи эҷодкор ──
              _NavTile(
              ...
              _NavTile(
                ...
                title: tr('aifeed.title'),
                sub:   tr('aifeed.entrySub'),
                onTap: () => _go(ctx, const AiFeedScreen()),
              ),
              // ── Creator Marketplace ──
              _NavTile(
